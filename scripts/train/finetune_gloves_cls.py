# ============================================================
# 장갑 분류기 Fine-tune
# - 기존 weights/gloves_cls.pt 에서 이어 학습
# - 적은 epoch(5) + 낮은 lr(1e-4) 로 약점 샘플 반영
# - 결과: weights/gloves_cls.pt (덮어쓰기 전 gloves_cls.prev.pt 로 백업)
# ============================================================
...
BACKUP_PATH = WEIGHTS_DIR / "gloves_cls.prev.pt"
...
def main():
    ...
    if not WEIGHT_PATH.exists():
        raise FileNotFoundError(f"{WEIGHT_PATH} 없음 — 먼저 train_gloves_cls.py 를 실행하세요.")
